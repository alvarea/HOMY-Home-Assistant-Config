...
void setup() {
  ...
  //   build_path: esphome_esp32_hub2_ble
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  App.pre_setup("esphome_esp32_hub2_ble", __DATE__ ", " __TIME__);
  // binary_sensor:
  // logger:
  //   id: logger_logger
  //   baud_rate: 115200
  ...
  status_statusbinarysensor->set_name("esphome esp32 hub2 status");
