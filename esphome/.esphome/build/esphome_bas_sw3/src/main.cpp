...
esp8266_pwm::ESP8266PWM *bas_sw3_green_led;
...
void setup() {
  ...
  //   build_path: .esphome/build/esphome_bas_sw3
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("esphome_bas_sw3", __DATE__ ", " __TIME__, false);
  // binary_sensor:
  // switch:
  // light:
  // logger:
  ...
  gpio_gpiobinarysensor->set_name("esphome bas sw3 boton");
  ...
  status_statusbinarysensor->set_name("esphome bas sw3 status");
  ...
  //   frequency: 1000.0
  bas_sw3_green_led = new esp8266_pwm::ESP8266PWM();
  bas_sw3_green_led->set_component_source("esp8266_pwm.output");
  App.register_component(bas_sw3_green_led);
  bas_sw3_green_led->set_zero_means_zero(false);
  ...
  bas_sw3_green_led->set_pin(esphome_esp8266_esp8266gpiopin_3);
  bas_sw3_green_led->set_frequency(1000.0f);
  // light.monochromatic:
  ...
  light_lightstate->set_name("esphome bas sw3 led");
  ...
  monochromatic_monochromaticlightoutput->set_output(bas_sw3_green_led);
  // network:
  //   {}
  // socket:
