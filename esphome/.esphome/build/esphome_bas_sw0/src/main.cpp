...
void setup() {
  ...
  //   build_path: .esphome/build/esphome_bas_sw0
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("esphome_bas_sw0", __DATE__ ", " __TIME__, false);
  // binary_sensor:
  // switch:
  // light:
  // logger:
  ...
  wifi_wifiap.set_manual_ip(wifi::ManualIP{
      .static_ip = network::IPAddress(192, 168, 0, 30),
  ...
  bas_sw0_green_led->set_component_source("esp8266_pwm.output");
  App.register_component(bas_sw0_green_led);
  bas_sw0_green_led->set_zero_means_zero(false);
  ...
  bas_sw0_green_led->set_pin(esphome_esp8266_esp8266gpiopin_3);
  ...
  light_lightstate->set_name("esphome bas sw0 led");
