...
void setup() {
  ...
  //   build_path: .esphome/build/esphome_4ch_sw3
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("esphome_4ch_sw3", __DATE__ ", " __TIME__, false);
  // binary_sensor:
  // switch:
  // light:
  // logger:
  ...
  wifi_wifiap.set_manual_ip(wifi::ManualIP{
      .static_ip = network::IPAddress(192, 168, 0, 43),
  ...
  light_lightstate->set_name("esphome 4ch sw3 blue led");
