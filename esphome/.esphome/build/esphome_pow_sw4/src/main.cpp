...
esp8266_pwm::ESP8266PWM *esphome_pow_sw4_green_led;
...
void setup() {
  ...
  // esphome:
  //   name: esphome_pow_sw4
  //   build_path: .esphome/build/esphome_pow_sw4
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("esphome_pow_sw4", __DATE__ ", " __TIME__, false);
  // binary_sensor:
  // switch:
  // light:
  // logger:
  ...
  wifi_wificomponent->set_use_address("192.168.0.39");
  ...
  wifi_wifiap.set_manual_ip(wifi::ManualIP{
      .static_ip = network::IPAddress(192, 168, 0, 39),
  ...
  gpio_gpiobinarysensor->set_name("esphome_pow_sw4_boton");
  ...
  status_statusbinarysensor->set_name("esphome_pow_sw4_status");
  ...
  gpio_gpioswitch->set_name("esphome_pow_sw4");
  ...
  //   frequency: 1000.0
  esphome_pow_sw4_green_led = new esp8266_pwm::ESP8266PWM();
  esphome_pow_sw4_green_led->set_component_source("esp8266_pwm.output");
  App.register_component(esphome_pow_sw4_green_led);
  esphome_pow_sw4_green_led->set_zero_means_zero(false);
  ...
  esphome_pow_sw4_green_led->set_pin(esphome_esp8266_esp8266gpiopin_3);
  esphome_pow_sw4_green_led->set_frequency(1000.0f);
  // light.monochromatic:
  //   platform: monochromatic
  //   name: esphome_pow_sw4_led
  //   output: esphome_pow_sw4_green_led
  //   disabled_by_default: false
  //   id: light_lightstate
  //   restore_mode: RESTORE_DEFAULT_OFF
  //   gamma_correct: 2.8
  ...
  light_lightstate->set_name("esphome_pow_sw4_led");
  ...
  monochromatic_monochromaticlightoutput->set_output(esphome_pow_sw4_green_led);
  // uart:
  //   rx_pin:
  //     number: 3
  //     mode:
  ...
  sensor_sensor_2->set_name("esphome_pow_sw4_voltage");
  ...
  sensor_sensor->set_name("esphome_pow_sw4_current");
  ...
  sensor_sensor_3->set_name("esphome_pow_sw4_power");
