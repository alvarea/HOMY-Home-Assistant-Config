...
esp8266_pwm::ESP8266PWM *pow_sw4_green_led;
...
void setup() {
  ...
  gpio_gpiobinarysensor->set_name("esphome pow sw4 boton");
  ...
  status_statusbinarysensor->set_name("esphome pow sw4 status");
  ...
  gpio_gpioswitch->set_name("esphome pow sw4");
  ...
  //   frequency: 1000.0
  pow_sw4_green_led = new esp8266_pwm::ESP8266PWM();
  pow_sw4_green_led->set_component_source("esp8266_pwm.output");
  App.register_component(pow_sw4_green_led);
  pow_sw4_green_led->set_zero_means_zero(false);
  ...
  pow_sw4_green_led->set_pin(esphome_esp8266_esp8266gpiopin_3);
  pow_sw4_green_led->set_frequency(1000.0f);
  // light.monochromatic:
  //   platform: monochromatic
  //   name: esphome pow sw4 led
  //   output: pow_sw4_green_led
  //   disabled_by_default: false
  //   id: light_lightstate
  //   restore_mode: RESTORE_DEFAULT_OFF
  //   gamma_correct: 2.8
  ...
  light_lightstate->set_name("esphome pow sw4 led");
  ...
  monochromatic_monochromaticlightoutput->set_output(pow_sw4_green_led);
  // uart:
  //   rx_pin:
  //     number: 3
  //     mode:
  ...
  sensor_sensor_2->set_name("esphome pow sw4 Voltage");
  ...
  sensor_sensor->set_name("esphome pow sw4 Current");
  ...
  sensor_sensor_3->set_name("esphome pow sw4 Power");
