...
esp8266_pwm::ESP8266PWM *s20_sw3_green_led;
...
void setup() {
  ...
  // esphome:
  //   name: esphome_s20_sw3
  //   build_path: .esphome/build/esphome_s20_sw3
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("esphome_s20_sw3", __DATE__ ", " __TIME__, false);
  // binary_sensor:
  // switch:
  // light:
  // logger:
  ...
  wifi_wificomponent->set_use_address("192.168.0.40");
  ...
  wifi_wifiap.set_manual_ip(wifi::ManualIP{
      .static_ip = network::IPAddress(192, 168, 0, 40),
  ...
  gpio_gpiobinarysensor->set_name("esphome s20 sw3 boton");
  ...
  status_statusbinarysensor->set_name("esphome s20 sw3 status");
  ...
  gpio_gpioswitch->set_name("esphome s20 sw3");
  ...
  //   frequency: 1000.0
  s20_sw3_green_led = new esp8266_pwm::ESP8266PWM();
  s20_sw3_green_led->set_component_source("esp8266_pwm.output");
  App.register_component(s20_sw3_green_led);
  s20_sw3_green_led->set_zero_means_zero(false);
  ...
  s20_sw3_green_led->set_pin(esphome_esp8266_esp8266gpiopin_3);
  s20_sw3_green_led->set_frequency(1000.0f);
  // light.monochromatic:
  //   platform: monochromatic
  //   name: esphome s20 sw3 led
  //   output: s20_sw3_green_led
  //   disabled_by_default: false
  //   id: light_lightstate
  //   restore_mode: RESTORE_DEFAULT_OFF
  //   gamma_correct: 2.8
  ...
  light_lightstate->set_name("esphome s20 sw3 led");
  ...
  monochromatic_monochromaticlightoutput->set_output(s20_sw3_green_led);
  // network:
  //   {}
  // socket:
