...
esp8266_pwm::ESP8266PWM *esphome_pow_sw2_green_led;
...
void setup() {
  ...
  gpio_gpiobinarysensor->set_name("esphome_pow_sw2_boton");
  ...
  status_statusbinarysensor->set_name("esphome_pow_sw2_status");
  ...
  gpio_gpioswitch->set_name("esphome_pow_sw2");
  ...
  //   frequency: 1000.0
  esphome_pow_sw2_green_led = new esp8266_pwm::ESP8266PWM();
  esphome_pow_sw2_green_led->set_component_source("esp8266_pwm.output");
  App.register_component(esphome_pow_sw2_green_led);
  esphome_pow_sw2_green_led->set_zero_means_zero(false);
  ...
  esphome_pow_sw2_green_led->set_pin(esphome_esp8266_esp8266gpiopin_3);
  esphome_pow_sw2_green_led->set_frequency(1000.0f);
  // light.monochromatic:
  //   platform: monochromatic
  //   name: esphome_pow_sw2_led
  //   output: esphome_pow_sw2_green_led
  //   disabled_by_default: false
  //   id: light_lightstate
  //   restore_mode: RESTORE_DEFAULT_OFF
  //   gamma_correct: 2.8
  ...
  light_lightstate->set_name("esphome_pow_sw2_led");
  ...
  monochromatic_monochromaticlightoutput->set_output(esphome_pow_sw2_green_led);
  // uart:
  //   rx_pin:
  //     number: 3
  //     mode:
  ...
  sensor_sensor_2->set_name("esphome_pow_sw2_voltage");
  ...
  sensor_sensor->set_name("esphome_pow_sw2_current");
  ...
  sensor_sensor_3->set_name("esphome_pow_sw2_power");
