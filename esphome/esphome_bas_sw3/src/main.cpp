...
void setup() {
  ...
  //   build_path: esphome_bas_sw3
  //   platformio_options: {}
  //   esp8266_restore_from_flash: false
  //   includes: []
  //   libraries: []
  App.pre_setup("esphome_bas_sw3", __DATE__ ", " __TIME__);
  // binary_sensor:
  // switch:
  // light:
  // logger:
  ...
  light_lightstate = new light::LightState("esphome bas sw3 led", monochromatic_monochromaticlightoutput);
  ...
  bas_sw3_green_led->set_pin(new GPIOPin(13, OUTPUT, true));
